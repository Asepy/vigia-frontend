...
const Claims: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>VigiA - Reclamar</title>
        <meta name="description" content="Reclamar" />
        ...
        >
          ...
          >
            <Box className={styles.StartActionTitle}>
              Estás analizando un llamado y ¿encontraste un potencial problema?
            </Box>
            ...
            {/*<Link href="questions/identifiedProcess">
      <a> </a></Link>
